...
Generate content for section `section-01-config` (filename: `section-01-config.md`).
...
for `section-01-config` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-01-config.md`
