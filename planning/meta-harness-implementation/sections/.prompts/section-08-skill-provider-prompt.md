...
Generate content for section `section-08-skill-provider` (filename: `section-08-skill-provider.md`).
...
for `section-08-skill-provider` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-08-skill-provider.md`
