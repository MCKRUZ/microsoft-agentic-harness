...
Generate content for section `section-02-secret-redaction` (filename: `section-02-secret-redaction.md`).
...
for `section-02-secret-redaction` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-02-secret-redaction.md`
