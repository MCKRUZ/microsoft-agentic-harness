...
Generate content for section `section-03-trace-domain` (filename: `section-03-trace-domain.md`).
...
for `section-03-trace-domain` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-03-trace-domain.md`
