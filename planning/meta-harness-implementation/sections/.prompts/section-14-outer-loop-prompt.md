...
Generate content for section `section-14-outer-loop` (filename: `section-14-outer-loop.md`).
...
for `section-14-outer-loop` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-14-outer-loop.md`
