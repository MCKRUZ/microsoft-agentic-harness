...
Generate content for section `section-04-trace-infrastructure` (filename: `section-04-trace-infrastructure.md`).
...
for `section-04-trace-infrastructure` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-04-trace-infrastructure.md`
