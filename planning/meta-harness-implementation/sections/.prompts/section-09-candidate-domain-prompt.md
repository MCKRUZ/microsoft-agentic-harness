...
Generate content for section `section-09-candidate-domain` (filename: `section-09-candidate-domain.md`).
...
for `section-09-candidate-domain` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-09-candidate-domain.md`
