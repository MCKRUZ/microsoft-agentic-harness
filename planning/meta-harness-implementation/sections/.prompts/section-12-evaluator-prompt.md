...
Generate content for section `section-12-evaluator` (filename: `section-12-evaluator.md`).
...
for `section-12-evaluator` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-12-evaluator.md`
