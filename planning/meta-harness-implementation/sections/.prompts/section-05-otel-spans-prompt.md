...
Generate content for section `section-05-otel-spans` (filename: `section-05-otel-spans.md`).
...
for `section-05-otel-spans` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-05-otel-spans.md`
