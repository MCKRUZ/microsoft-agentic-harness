...
Generate content for section `section-13-tools` (filename: `section-13-tools.md`).
...
for `section-13-tools` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-13-tools.md`
