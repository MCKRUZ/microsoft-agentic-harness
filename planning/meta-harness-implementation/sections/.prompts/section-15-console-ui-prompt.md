...
Generate content for section `section-15-console-ui` (filename: `section-15-console-ui.md`).
...
for `section-15-console-ui` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-15-console-ui.md`
