...
Generate content for section `section-11-proposer` (filename: `section-11-proposer.md`).
...
for `section-11-proposer` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-11-proposer.md`
