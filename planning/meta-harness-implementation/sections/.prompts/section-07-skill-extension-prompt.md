...
Generate content for section `section-07-skill-extension` (filename: `section-07-skill-extension.md`).
...
for `section-07-skill-extension` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\planning\meta-harness-implementation/sections/section-07-skill-extension.md`
