...
## Documentation
- **Developer Onboarding Guide**: `documentation/onboarding/` — 17-page guide for engineers (deployed at `/`). Chapter 17 is the Bundle API integration guide; its OpenAPI spec is `documentation/onboarding/assets/openapi/bundle-api.yaml` (hand-written — update it with any contract change)
