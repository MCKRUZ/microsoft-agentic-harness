...
## Documentation
- **Developer Onboarding Guide**: `documentation/onboarding/` — 17-page guide for engineers (deployed at `/`). Chapter 17 is the Bundle API integration guide; its OpenAPI spec is `documentation/onboarding/assets/openapi/bundle-api.yaml` (hand-written; to change the contract, follow *Change the wire contract* in `src/Content/Presentation/Presentation.BundleApi/README.md`)
