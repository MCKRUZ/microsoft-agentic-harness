...
Generate content for section `section-05-otel-bridge` (filename: `section-05-otel-bridge.md`).
...
for `section-05-otel-bridge` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\.claude\planning\webui-agenthub/sections/section-05-otel-bridge.md`
