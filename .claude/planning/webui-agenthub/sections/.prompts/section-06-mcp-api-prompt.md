...
Generate content for section `section-06-mcp-api` (filename: `section-06-mcp-api.md`).
...
for `section-06-mcp-api` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\.claude\planning\webui-agenthub/sections/section-06-mcp-api.md`
