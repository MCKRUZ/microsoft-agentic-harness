...
Generate content for section `section-08-webui-shell` (filename: `section-08-webui-shell.md`).
...
for `section-08-webui-shell` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\microsoft-agentic-harness\.claude\planning\webui-agenthub/sections/section-08-webui-shell.md`
