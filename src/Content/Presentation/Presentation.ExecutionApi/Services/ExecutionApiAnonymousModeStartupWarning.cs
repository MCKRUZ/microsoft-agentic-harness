...
/// </summary>
internal sealed class ExecutionApiAnonymousModeStartupWarning : IHostedService
{
    private readonly ILogger<ExecutionApiAnonymousModeStartupWarning> _logger;

    /// <summary>Initializes a new <see cref="ExecutionApiAnonymousModeStartupWarning"/>.</summary>
    public ExecutionApiAnonymousModeStartupWarning(ILogger<ExecutionApiAnonymousModeStartupWarning> logger)
    {
        _logger = logger;
    }
