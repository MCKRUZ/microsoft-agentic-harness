...
public sealed class ConversationSpanProcessor : BaseProcessor<Activity>
{
    ...
    [
        TelemetrySourceNames.AgenticHarness,
        TelemetrySourceNames.AgenticHarnessMediatR
    ];

    private static readonly string[] BaggageKeys =
    [
        AgenticSemanticConventions.Agent.ConversationId,
        AgenticSemanticConventions.Agent.TurnIndex,
        AgenticSemanticConventions.Agent.Name,
    ];
