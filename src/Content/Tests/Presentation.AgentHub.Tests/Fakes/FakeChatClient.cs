...
public sealed class FakeChatClient : IChatClient
{
    ...
    /// <summary>Enqueues a response with tool call requests.</summary>
    public FakeChatClient EnqueueToolCallResponse(string toolName, string arguments)
    {
        var message = new ChatMessage(ChatRole.Assistant, [new FunctionCallContent("call_1", toolName, new Dictionary<string, object?> { ["input"] = arguments })]);
